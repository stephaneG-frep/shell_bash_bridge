...
import '../features/distros/presentation/linux_package_managers_screen.dart';
import '../features/notes/presentation/notes_plus_screen.dart';
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/linux-packages',
      builder: (context, state) => const LinuxPackageManagersScreen(),
    ),
    GoRoute(
      path: '/notes',
      builder: (context, state) => const NotesPlusScreen(),
    ),
    GoRoute(
      path: '/answers',
